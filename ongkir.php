...
class Ongkir extends CarrierModule
{
    ...
    public function __construct()
    {
        ...
        $this->displayName = $this->l('Ongkir');
        $this->description = $this->l('Shipping rates for Indonesia');

        $this->confirmUninstall = $this->l('Your past shipping rates may lost');
    ...
    public function install()
    {
        ...
        Configuration::updateValue('ONGKIR_LIVE_MODE', false);
    ...
    {
        Configuration::deleteByName('ONGKIR_LIVE_MODE');
    ...
    public function getContent()
    {
         ...
         */
        if (((bool)Tools::isSubmit('submitOngkirModule')) == true) {
            $this->postProcess();
        }
    ...
    protected function renderForm()
    {
        ...
        $helper->submit_action = 'submitOngkirModule';
            ...
            'form' => array(
                ...
                'input' => array(
                    ...
                    array(
                        ...
                        'name' => 'ONGKIR_ACCOUNT_EMAIL',
                        'label' => $this->l('Email'),
                    ),
                    array(
                        'type' => 'password',
                        'name' => 'ONGKIR_ACCOUNT_PASSWORD',
    ...
    {
        return array(
            'ONGKIR_LIVE_MODE' => Configuration::get('ONGKIR_LIVE_MODE', true),
            'ONGKIR_ACCOUNT_EMAIL' => Configuration::get('ONGKIR_ACCOUNT_EMAIL', 'contact@prestashop.com'),
            'ONGKIR_ACCOUNT_PASSWORD' => Configuration::get('ONGKIR_ACCOUNT_PASSWORD', null),
        );
    }
